...
const client = redis.createClient(cfg.cacheUrl);
client.hget = util.promisify(client.hget);
client.on('error', function(err) {
  console.log(`error in communicating with redis client`);
});


//MongoDB Exposed Methods to App
...
//Redis Cache Exposed Methods to App
module.exports = {
  clearHash(hashKey) {
